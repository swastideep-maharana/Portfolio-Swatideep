          ...
          {navlinks.map((link: Navlink, index: number) => (
            ...
            >
              ...
              >
                ...
                <span
                  className="absolute -top-12 left-1/2 -translate-x-1/2 px-2 py-1 text-xs font-medium text-white bg-black/80 dark:bg-white/10 backdrop-blur-sm rounded-md whitespace-nowrap opacity-0 pointer-events-none transition-opacity duration-200"
                  style={{
